...
#define IS_FL_BSTIM32_AUTORELOAD_MODE(__VALUE__) (((__VALUE__) == FL_ENABLE) || ((__VALUE__) == FL_DISABLE))

#define IS_FL_BSTIM32_CLOCK_SRC(__VALUE__)                                                                             \
    (((__VALUE__) == FL_RCC_BSTIM32_CLK_SOURCE_APB2CLK) || ((__VALUE__) == FL_RCC_BSTIM32_CLK_SOURCE_LSCLK) ||         \
     ((__VALUE__) == FL_RCC_BSTIM32_CLK_SOURCE_LPOSC) || ((__VALUE__) == FL_RCC_BSTIM32_CLK_SOURCE_RCMF_PSC))
