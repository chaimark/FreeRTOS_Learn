...
#define IS_FL_IWDT_OVERFLOWPERIOD(__VALUE__)                                                                           \
    (((__VALUE__) == FL_IWDT_PERIOD_125MS) || ((__VALUE__) == FL_IWDT_PERIOD_250MS) ||                                 \
     ((__VALUE__) == FL_IWDT_PERIOD_500MS) || ((__VALUE__) == FL_IWDT_PERIOD_1000MS) ||                                \
     ((__VALUE__) == FL_IWDT_PERIOD_2000MS) || ((__VALUE__) == FL_IWDT_PERIOD_4000MS) ||                               \
     ((__VALUE__) == FL_IWDT_PERIOD_8000MS) || ((__VALUE__) == FL_IWDT_PERIOD_16000MS))
/**
 * @}
 */
