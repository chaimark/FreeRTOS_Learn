...
#define IS_FL_U7816_CLOCK_FRQUENCE(__VALUE__) (((__VALUE__) >= 1000000) || ((__VALUE__) <= 5000000))

#define IS_FL_U7816_TX_PARITHERROR_AUTO_RETRY(__VALUE__) (((__VALUE__) == FL_DISABLE) || ((__VALUE__) == FL_ENABLE))

#define IS_FL_U7816_RETRY_CNT(__VALUE__)                                                                               \
    (((__VALUE__) == FL_U7816_RETRY_COUNT_1) || ((__VALUE__) == FL_U7816_RETRY_COUNT_3))

#define IS_FL_U7816_BLOCKGUARD(__VALUE__) (((__VALUE__) == FL_ENABLE) || ((__VALUE__) == FL_DISABLE))

#define IS_FL_U7816_AUTO_PULL(__VALUE__) (((__VALUE__) == FL_ENABLE) || ((__VALUE__) == FL_DISABLE))

#define IS_FL_U7816_PARITH(__VALUE__)                                                                                  \
    (((__VALUE__) == FL_U7816_PARITY_EVEN) || ((__VALUE__) == FL_U7816_PARITY_ODD) ||                                  \
     ((__VALUE__) == FL_U7816_PARITY_ALWAYS_1) || ((__VALUE__) == FL_U7816_PARITY_NONE))

#define IS_FL_U7816_TX_GUARD(__VALUE__)                                                                                \
    (((__VALUE__) == FL_U7816_TX_GUARD_TIME_2ETU) || ((__VALUE__) == FL_U7816_TX_GUARD_TIME_3ETU))

#define IS_FL_U7816_RX_GUARD(__VALUE__)                                                                                \
    (((__VALUE__) == FL_U7816_RX_GUARD_TIME_2ETU) || ((__VALUE__) == FL_U7816_RX_GUARD_TIME_1ETU))

#define IS_FL_U7816_ERROR_GUARD(__VALUE__)                                                                             \
    (((__VALUE__) == FL_U7816_ERROR_GUARD_TIME_2ETU) || ((__VALUE__) == FL_U7816_ERROR_GUARD_TIME_1ETU))

#define IS_FL_U7816_ERROR_SIGNALWIDTH(__VALUE__)                                                                       \
    (((__VALUE__) == FL_U7816_ERROR_SIGNAL_WIDTH_2ETU) || ((__VALUE__) == FL_U7816_ERROR_SIGNAL_WIDTH_1P5ETU) ||       \
     ((__VALUE__) == FL_U7816_ERROR_SIGNAL_WIDTH_1ETU))

#define IS_FL_U7816_RX_AUTO_ERROR_SIG(__VALUE__) (((__VALUE__) == FL_DISABLE) || ((__VALUE__) == FL_ENABLE))

#define IS_FL_U7816_BIT_DIRECTION(__VALUE__)                                                                           \
    (((__VALUE__) == FL_U7816_BIT_ORDER_LSB_FIRST) || ((__VALUE__) == FL_U7816_BIT_ORDER_MSB_FIRST))
/**
 * @}
 */
