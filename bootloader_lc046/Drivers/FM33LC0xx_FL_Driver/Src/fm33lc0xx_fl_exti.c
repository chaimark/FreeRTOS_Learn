...
static const pSetExtiLineFunc setExtiLineFuncs[] = {
    FL_GPIO_SetExtiLine0,  FL_GPIO_SetExtiLine1,  FL_GPIO_SetExtiLine2,  FL_GPIO_SetExtiLine3,
    FL_GPIO_SetExtiLine4,  FL_GPIO_SetExtiLine5,  FL_GPIO_SetExtiLine6,  FL_GPIO_SetExtiLine7,
    FL_GPIO_SetExtiLine8,  FL_GPIO_SetExtiLine9,  FL_GPIO_SetExtiLine10, NULL,
    FL_GPIO_SetExtiLine12, FL_GPIO_SetExtiLine13, FL_GPIO_SetExtiLine14,
};
