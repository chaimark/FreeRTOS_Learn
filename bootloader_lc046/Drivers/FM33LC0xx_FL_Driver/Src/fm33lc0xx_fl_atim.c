...
#define IS_ATIM_CLKSRC(__VALUE__)                                                                                      \
    (((__VALUE__) == FL_RCC_ATIM_CLK_SOURCE_APB2CLK) || ((__VALUE__) == FL_RCC_ATIM_CLK_SOURCE_PLLx2)) ||              \
        ((__VALUE__) == FL_RCC_ATIM_CLK_SOURCE_USBPHYBCK120M)


#define IS_FL_ATIM_COUNTERMODE(__VALUE__)                                                                              \
    (((__VALUE__) == FL_ATIM_COUNTER_DIR_UP) || ((__VALUE__) == FL_ATIM_COUNTER_DIR_DOWN) ||                           \
     ((__VALUE__) == FL_ATIM_COUNTER_ALIGNED_CENTER_DOWN) || ((__VALUE__) == FL_ATIM_COUNTER_ALIGNED_CENTER_UP) ||     \
     ((__VALUE__) == FL_ATIM_COUNTER_ALIGNED_CENTER_UP_DOWN))

#define IS_FL_ATIM_CLOCKDIVISION(__VALUE__)                                                                            \
    (((__VALUE__) == FL_ATIM_CLK_DIVISION_DIV1) || ((__VALUE__) == FL_ATIM_CLK_DIVISION_DIV2) ||                       \
     ((__VALUE__) == FL_ATIM_CLK_DIVISION_DIV4))


#define IS_FL_ATIM_CC_MODE(__VALUE__)                                                                                  \
    (((__VALUE__) == FL_ATIM_CHANNEL_MODE_OUTPUT) || ((__VALUE__) == FL_ATIM_CHANNEL_MODE_INPUT_NORMAL) ||             \
     ((__VALUE__) == FL_ATIM_CHANNEL_MODE_INPUT_CROSSOVER) || ((__VALUE__) == FL_ATIM_CHANNEL_MODE_INPUT_TRC))

#define IS_FL_ATIM_IC_FILTER(__VALUE__)                                                                                \
    (((__VALUE__) == FL_ATIM_IC_FILTER_DIV1) || ((__VALUE__) == FL_ATIM_IC_FILTER_DIV1_N2) ||                          \
     ((__VALUE__) == FL_ATIM_IC_FILTER_DIV1_N4) || ((__VALUE__) == FL_ATIM_IC_FILTER_DIV1_N8) ||                       \
     ((__VALUE__) == FL_ATIM_IC_FILTER_DIV2_N6) || ((__VALUE__) == FL_ATIM_IC_FILTER_DIV2_N8) ||                       \
     ((__VALUE__) == FL_ATIM_IC_FILTER_DIV4_N6) || ((__VALUE__) == FL_ATIM_IC_FILTER_DIV4_N8) ||                       \
     ((__VALUE__) == FL_ATIM_IC_FILTER_DIV8_N6) || ((__VALUE__) == FL_ATIM_IC_FILTER_DIV8_N8) ||                       \
     ((__VALUE__) == FL_ATIM_IC_FILTER_DIV16_N5) || ((__VALUE__) == FL_ATIM_IC_FILTER_DIV16_N6) ||                     \
     ((__VALUE__) == FL_ATIM_IC_FILTER_DIV16_N8) || ((__VALUE__) == FL_ATIM_IC_FILTER_DIV32_N5) ||                     \
     ((__VALUE__) == FL_ATIM_IC_FILTER_DIV32_N6) || ((__VALUE__) == FL_ATIM_IC_FILTER_DIV32_N8))

#define IS_FL_ATIM_CHANNEL(__VALUE__)                                                                                  \
    (((__VALUE__) == FL_ATIM_CHANNEL_1) || ((__VALUE__) == FL_ATIM_CHANNEL_2) || ((__VALUE__) == FL_ATIM_CHANNEL_3) || \
     ((__VALUE__) == FL_ATIM_CHANNEL_4))


#define IS_FL_ATIM_SLAVE_MODE(__VALUE__)                                                                               \
    (((__VALUE__) == FL_ATIM_SLAVE_MODE_PROHIBITED) || ((__VALUE__) == FL_ATIM_SLAVE_MODE_ENCODER_X2_TI1) ||           \
     ((__VALUE__) == FL_ATIM_SLAVE_MODE_ENCODER_X2_TI2) || ((__VALUE__) == FL_ATIM_SLAVE_MODE_ENCODER_X4_TI1TI2) ||    \
     ((__VALUE__) == FL_ATIM_SLAVE_MODE_TRGI_RISE_RST) || ((__VALUE__) == FL_ATIM_SLAVE_MODE_TRGI_HIGH_RUN) ||         \
     ((__VALUE__) == FL_ATIM_SLAVE_MODE_TRGI_RISE_RUN) || ((__VALUE__) == FL_ATIM_SLAVE_MODE_TRGI_CLK))


#define IS_FL_ATIM_TRIGGER_SRC(__VALUE__)                                                                              \
    (((__VALUE__) == FL_ATIM_TRGI_ITR0) || ((__VALUE__) == FL_ATIM_TRGI_ITR1) || ((__VALUE__) == FL_ATIM_TRGI_ITR2) || \
     ((__VALUE__) == FL_ATIM_TRGI_ITR3) || ((__VALUE__) == FL_ATIM_TRGI_TI1F_EDGE) ||                                  \
     ((__VALUE__) == FL_ATIM_TRGI_TI1FP1) || ((__VALUE__) == FL_ATIM_TRGI_TI2FP2) ||                                   \
     ((__VALUE__) == FL_ATIM_TRGI_ETRF))


#define IS_FL_ATIM_ETP_FILTER(__VALUE__)                                                                               \
    (((__VALUE__) == FL_ATIM_ETR_FILTER_DIV1) || ((__VALUE__) == FL_ATIM_ETR_FILTER_DIV1_N2) ||                        \
     ((__VALUE__) == FL_ATIM_ETR_FILTER_DIV1_N4) || ((__VALUE__) == FL_ATIM_ETR_FILTER_DIV1_N8) ||                     \
     ((__VALUE__) == FL_ATIM_ETR_FILTER_DIV2_N6) || ((__VALUE__) == FL_ATIM_ETR_FILTER_DIV2_N8) ||                     \
     ((__VALUE__) == FL_ATIM_ETR_FILTER_DIV4_N6) || ((__VALUE__) == FL_ATIM_ETR_FILTER_DIV4_N8) ||                     \
     ((__VALUE__) == FL_ATIM_ETR_FILTER_DIV8_N6) || ((__VALUE__) == FL_ATIM_ETR_FILTER_DIV8_N8) ||                     \
     ((__VALUE__) == FL_ATIM_ETR_FILTER_DIV16_N5) || ((__VALUE__) == FL_ATIM_ETR_FILTER_DIV16_N6) ||                   \
     ((__VALUE__) == FL_ATIM_ETR_FILTER_DIV16_N8) || ((__VALUE__) == FL_ATIM_ETR_FILTER_DIV32_N5) ||                   \
     ((__VALUE__) == FL_ATIM_ETR_FILTER_DIV32_N6) || ((__VALUE__) == FL_ATIM_ETR_FILTER_DIV32_N8))


#define IS_FL_ATIM_ETR_PSC(__VALUE__)                                                                                  \
    (((__VALUE__) == FL_ATIM_ETR_PSC_DIV1) || ((__VALUE__) == FL_ATIM_ETR_PSC_DIV2) ||                                 \
     ((__VALUE__) == FL_ATIM_ETR_PSC_DIV4) || ((__VALUE__) == FL_ATIM_ETR_PSC_DIV8))


#define IS_FL_ATIM_ETR_POLARITY(__VALUE__)                                                                             \
    (((__VALUE__) == FL_ATIM_ETR_POLARITY_NORMAL) || ((__VALUE__) == FL_ATIM_ETR_POLARITY_INVERT))


#define IS_FL_ATIM_IC_POLARITY(__VALUE__)                                                                              \
    (((__VALUE__) == FL_ATIM_IC_POLARITY_NORMAL) || ((__VALUE__) == FL_ATIM_IC_POLARITY_INVERT))


#define IS_FL_ATIM_IC_ACTIVEINPUT(__VALUE__)                                                                           \
    (((__VALUE__) == FL_ATIM_CHANNEL_MODE_INPUT_NORMAL) || ((__VALUE__) == FL_ATIM_CHANNEL_MODE_INPUT_CROSSOVER) ||    \
     ((__VALUE__) == FL_ATIM_CHANNEL_MODE_INPUT_TRC))


#define IS_FL_ATIM_IC_PRESCALER(__VALUE__)                                                                             \
    (((__VALUE__) == FL_ATIM_IC_PSC_DIV1) || ((__VALUE__) == FL_ATIM_IC_PSC_DIV2) ||                                   \
     ((__VALUE__) == FL_ATIM_IC_PSC_DIV4) || ((__VALUE__) == FL_ATIM_IC_PSC_DIV8))


#define IS_FL_ATIM_OC_POLARITY(__VALUE__)                                                                              \
    (((__VALUE__) == FL_ATIM_OC_POLARITY_NORMAL) || ((__VALUE__) == FL_ATIM_OC_POLARITY_INVERT))


#define IS_FL_ATIM_OC_MODE(__VALUE__)                                                                                  \
    (((__VALUE__) == FL_ATIM_OC_MODE_FROZEN) || ((__VALUE__) == FL_ATIM_OC_MODE_ACTIVE) ||                             \
     ((__VALUE__) == FL_ATIM_OC_MODE_INACTIVE) || ((__VALUE__) == FL_ATIM_OC_MODE_TOGGLE) ||                           \
     ((__VALUE__) == FL_ATIM_OC_MODE_FORCED_INACTIVE) || ((__VALUE__) == FL_ATIM_OC_MODE_FORCED_ACTIVE) ||             \
     ((__VALUE__) == FL_ATIM_OC_MODE_PWM1) || ((__VALUE__) == FL_ATIM_OC_MODE_PWM2))

#define IS_FL_ATIM_AUTORELOAB_STATE(__VALUE__) (((__VALUE__) == FL_ENABLE) || ((__VALUE__) == FL_DISABLE))

#define IS_FL_ATIM_OC_FASTMODE(__VALUE__) (((__VALUE__) == FL_ENABLE) || ((__VALUE__) == FL_DISABLE))

#define IS_FL_ATIM_OC_PRELOAD(__VALUE__) (((__VALUE__) == FL_ENABLE) || ((__VALUE__) == FL_DISABLE))

#define IS_FL_ATIM_OC_ETR_CLEARN(__VALUE__) (((__VALUE__) == FL_ENABLE) || ((__VALUE__) == FL_DISABLE))

#define IS_FL_ATIM_OC_STATE(__VALUE__) (((__VALUE__) == FL_ENABLE) || ((__VALUE__) == FL_DISABLE))

#define IS_FL_ATIM_OCN_STATE(__VALUE__) (((__VALUE__) == FL_ENABLE) || ((__VALUE__) == FL_DISABLE))

#define IS_FL_ATIM_OC_IDLESTATE(__VALUE__)                                                                             \
    (((__VALUE__) == FL_ATIM_OC_IDLE_STATE_LOW) || ((__VALUE__) == FL_ATIM_OC_IDLE_STATE_HIGH))

#define IS_FL_ATIM_OC_NIDLESTATE(__VALUE__)                                                                            \
    (((__VALUE__) == FL_ATIM_OCN_IDLE_STATE_LOW) || ((__VALUE__) == FL_ATIM_OCN_IDLE_STATE_HIGH))


#define IS_FL_ATIM_OC_NPOLARITY(__VALUE__)                                                                             \
    (((__VALUE__) == FL_ATIM_OCN_POLARITY_NORMAL) || ((__VALUE__) == FL_ATIM_OCN_POLARITY_INVERT))


#define IS_FL_ATIM_BDTR_FILTER(__VALUE__)                                                                              \
    (((__VALUE__) == FL_ATIM_BREAK_FILTER_DIV1) || ((__VALUE__) == FL_ATIM_BREAK_FILTER_DIV1_N2) ||                    \
     ((__VALUE__) == FL_ATIM_BREAK_FILTER_DIV1_N4) || ((__VALUE__) == FL_ATIM_BREAK_FILTER_DIV1_N8) ||                 \
     ((__VALUE__) == FL_ATIM_BREAK_FILTER_DIV2_N6) || ((__VALUE__) == FL_ATIM_BREAK_FILTER_DIV2_N8) ||                 \
     ((__VALUE__) == FL_ATIM_BREAK_FILTER_DIV4_N6) || ((__VALUE__) == FL_ATIM_BREAK_FILTER_DIV4_N8) ||                 \
     ((__VALUE__) == FL_ATIM_BREAK_FILTER_DIV8_N6) || ((__VALUE__) == FL_ATIM_BREAK_FILTER_DIV8_N8) ||                 \
     ((__VALUE__) == FL_ATIM_BREAK_FILTER_DIV16_N5) || ((__VALUE__) == FL_ATIM_BREAK_FILTER_DIV16_N6) ||               \
     ((__VALUE__) == FL_ATIM_BREAK_FILTER_DIV16_N8) || ((__VALUE__) == FL_ATIM_BREAK_FILTER_DIV32_N5) ||               \
     ((__VALUE__) == FL_ATIM_BREAK_FILTER_DIV32_N6) || ((__VALUE__) == FL_ATIM_BREAK_FILTER_DIV32_N8))

#define IS_FL_ATIM_OSSR_STATE(__VALUE__) (((__VALUE__) == FL_ATIM_OSSR_DISABLE) || ((__VALUE__) == FL_ATIM_OSSR_ENABLE))

#define IS_FL_ATIM_OSSI_STATE(__VALUE__) (((__VALUE__) == FL_ATIM_OSSI_DISABLE) || ((__VALUE__) == FL_ATIM_OSSI_ENABLE))

#define IS_FL_ATIM_LOCK_LEVEL(__VALUE__)                                                                               \
    (((__VALUE__) == FL_ATIM_LOCK_LEVEL_OFF) || ((__VALUE__) == FL_ATIM_LOCK_LEVEL_1) ||                               \
     ((__VALUE__) == FL_ATIM_LOCK_LEVEL_2) || ((__VALUE__) == FL_ATIM_LOCK_LEVEL_3))

#define IS_FL_ATIM_BREAK_POLARITY(__VALUE__)                                                                           \
    (((__VALUE__) == FL_ATIM_BREAK_POLARITY_LOW) || ((__VALUE__) == FL_ATIM_BREAK_POLARITY_HIGH))

#define IS_FL_ATIM_AUTOMATIC_OUTPUT_STATE(__VALUE__) (((__VALUE__) == FL_DISABLE) || ((__VALUE__) == FL_ENABLE))

#define IS_FL_ATIM_TRIGGER_DELAY(__VALUE__) (((__VALUE__) == FL_DISABLE) || ((__VALUE__) == FL_ENABLE))

#define IS_FL_ATIM_IC_CAPTURE_STATE(__VALUE__) (((__VALUE__) == FL_DISABLE) || ((__VALUE__) == FL_ENABLE))
