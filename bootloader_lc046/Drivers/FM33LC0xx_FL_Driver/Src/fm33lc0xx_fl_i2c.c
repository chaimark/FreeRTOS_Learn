...
#define IS_FL_I2C_CLOCKSRC(__VALUE__)                                                                                  \
    (((__VALUE__) == FL_RCC_I2C_CLK_SOURCE_APB1CLK) || ((__VALUE__) == FL_RCC_I2C_CLK_SOURCE_RCHF) ||                  \
     ((__VALUE__) == FL_RCC_I2C_CLK_SOURCE_SYSCLK) || ((__VALUE__) == FL_RCC_I2C_CLK_SOURCE_RCMF_PSC))

#define IS_FL_I2C_MSATER_TIMEOUT(__VALUE__)                                                                            \
    (((__VALUE__) == FL_IWDT_PERIOD_125MS) || ((__VALUE__) == FL_IWDT_PERIOD_16000MS))


#define IS_FL_I2C_SLAVE_ACK(__VALUE__) (((__VALUE__) == FL_ENABLE) || ((__VALUE__) == FL_DISABLE))


#define IS_FL_I2C_ANGLOGFILTER(__VALUE__) (((__VALUE__) == FL_ENABLE) || ((__VALUE__) == FL_DISABLE))

#define IS_FL_I2C_ADDRSIZE10BIT(__VALUE__) (((__VALUE__) == FL_ENABLE) || ((__VALUE__) == FL_DISABLE))

#define IS_FL_I2C_SLAVE_SCLSEN(__VALUE__) (((__VALUE__) == FL_ENABLE) || ((__VALUE__) == FL_DISABLE))
