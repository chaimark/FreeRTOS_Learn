...
#define IS_FL_CRC_POLYNOMIAL_WIDTH(__VALUE__)                                                                          \
    (((__VALUE__) == FL_CRC_POLYNOMIAL_16B) || ((__VALUE__) == FL_CRC_POLYNOMIAL_32B) ||                               \
     ((__VALUE__) == FL_CRC_POLYNOMIAL_8B) || ((__VALUE__) == FL_CRC_POLYNOMIAL_7B))

#define IS_FL_CRC_DR_WIDTH(__VALUE__) (((__VALUE__) == FL_CRC_DATA_WIDTH_8B) || ((__VALUE__) == FL_CRC_DATA_WIDTH_32B))


#define IS_FL_CRC_OUPUT_REFLECTE_MODE(__VALUE__)                                                                       \
    (((__VALUE__) == FL_CRC_OUPUT_INVERT_NONE) || ((__VALUE__) == FL_CRC_OUPUT_INVERT_BYTE))

#define IS_FL_CRC_INPUT_REFLECTE_MODE(__VALUE__)                                                                       \
    (((__VALUE__) == FL_CRC_INPUT_INVERT_NONE) || ((__VALUE__) == FL_CRC_INPUT_INVERT_BYTE) ||                         \
     ((__VALUE__) == FL_CRC_INPUT_INVERT_HALF_WORD) || ((__VALUE__) == FL_CRC_INPUT_INVERT_WORD))

#define IS_FL_CRC_CALCULA_MODE(__VALUE__)                                                                              \
    (((__VALUE__) == FL_CRC_CALCULATE_SERIAL) || ((__VALUE__) == FL_CRC_CALCULATE_PARALLEL))
