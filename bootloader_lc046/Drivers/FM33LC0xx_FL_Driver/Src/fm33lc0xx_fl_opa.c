...
#define IS_FL_OPA_INP_CHANNAL(__VALUE__)                                                                               \
    (((__VALUE__) == FL_OPA_INP_SOURCE_INP1) || ((__VALUE__) == FL_OPA_INP_SOURCE_INP2))


#define IS_FL_OPA_INN_CHANNAL(__VALUE__)                                                                               \
    (((__VALUE__) == FL_OPA_INN_SOURCE_INN1) || ((__VALUE__) == FL_OPA_INN_SOURCE_INN2) ||                             \
     ((__VALUE__) == FL_OPA_INN_SOURCE_VREF) || ((__VALUE__) == FL_OPA_INN_SOURCE_THREE_QUARTERS_VREF) ||              \
     ((__VALUE__) == FL_OPA_INN_SOURCE_HALF_VREF) || ((__VALUE__) == FL_OPA_INN_SOURCE_ONE_QUARTER_VREF) ||            \
     ((__VALUE__) == FL_OPA_INN_SOURCE_ONE_EIGHTH_VREF))

#define IS_FL_OPA_MODE(__VALUE__)                                                                                      \
    (((__VALUE__) == FL_OPA_MODE_STANDALONE) || ((__VALUE__) == FL_OPA_MODE_COMPARATOR) ||                             \
     ((__VALUE__) == FL_OPA_MODE_PGA) || ((__VALUE__) == FL_OPA_MODE_BUFFER))

#define IS_FL_OPA_DIGITALFILTER(__VALUE__) (((__VALUE__) == FL_DISABLE) || ((__VALUE__) == FL_ENABLE))

#define IS_FL_OPA_NEGTIVE_TO_PIN(__VALUE__) (((__VALUE__) == FL_DISABLE) || ((__VALUE__) == FL_ENABLE))

#define IS_FL_OPA_LOW_POWER_MODE(__VALUE__) (((__VALUE__) == FL_DISABLE) || ((__VALUE__) == FL_ENABLE))

#define IS_FL_OPA_GAIN(__VALUE__)                                                                                      \
    (((__VALUE__) == FL_OPA_GAIN_X2) || ((__VALUE__) == FL_OPA_GAIN_X4) || ((__VALUE__) == FL_OPA_GAIN_X8) ||          \
