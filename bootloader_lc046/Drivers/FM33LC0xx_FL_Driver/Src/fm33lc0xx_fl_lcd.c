...
#define IS_FL_LCD_BIASCURRENT(__VALUE__)                                                                               \
    (((__VALUE__) == (FL_LCD_BIAS_CURRENT_VERYHIGH)) || ((__VALUE__) == (FL_LCD_BIAS_CURRENT_HIGH)) ||                 \
     ((__VALUE__) == (FL_LCD_BIAS_CURRENT_MEDIUM)) || ((__VALUE__) == (FL_LCD_BIAS_CURRENT_LOW)))

#define IS_FL_LCD_ENMODE(__VALUE__) ((__VALUE__) == (FL_LCD_DRIVER_MODE_INNER_RESISTER))

#define IS_FL_LCD_BIASVOLTAGE(__VALUE__)                                                                               \
    (((__VALUE__) == (FL_LCD_BIAS_VOLTAGE_LEVEL0)) || ((__VALUE__) == (FL_LCD_BIAS_VOLTAGE_LEVEL1)) ||                 \
     ((__VALUE__) == (FL_LCD_BIAS_VOLTAGE_LEVEL2)) || ((__VALUE__) == (FL_LCD_BIAS_VOLTAGE_LEVEL3)) ||                 \
     ((__VALUE__) == (FL_LCD_BIAS_VOLTAGE_LEVEL4)) || ((__VALUE__) == (FL_LCD_BIAS_VOLTAGE_LEVEL5)) ||                 \
     ((__VALUE__) == (FL_LCD_BIAS_VOLTAGE_LEVEL6)) || ((__VALUE__) == (FL_LCD_BIAS_VOLTAGE_LEVEL7)) ||                 \
     ((__VALUE__) == (FL_LCD_BIAS_VOLTAGE_LEVEL8)) || ((__VALUE__) == (FL_LCD_BIAS_VOLTAGE_LEVEL9)) ||                 \
     ((__VALUE__) == (FL_LCD_BIAS_VOLTAGE_LEVEL10)) || ((__VALUE__) == (FL_LCD_BIAS_VOLTAGE_LEVEL11)) ||               \
     ((__VALUE__) == (FL_LCD_BIAS_VOLTAGE_LEVEL12)) || ((__VALUE__) == (FL_LCD_BIAS_VOLTAGE_LEVEL13)) ||               \
     ((__VALUE__) == (FL_LCD_BIAS_VOLTAGE_LEVEL14)) || ((__VALUE__) == (FL_LCD_BIAS_VOLTAGE_LEVEL15)))

#define IS_FL_LCD_BIASMD(__VALUE__)                                                                                    \
    (((__VALUE__) == (FL_LCD_BIAS_MODE_4BIAS)) || ((__VALUE__) == (FL_LCD_BIAS_MODE_3BIAS)))

#define IS_FL_LCD_BWFT(__VALUE__) (((__VALUE__) == (FL_LCD_WAVEFORM_TYPEA)) || ((__VALUE__) == (FL_LCD_WAVEFORM_TYPEB)))

#define IS_FL_LCD_LMUX(__VALUE__)                                                                                      \
    (((__VALUE__) == (FL_LCD_COM_NUM_4COM)) || ((__VALUE__) == (FL_LCD_COM_NUM_6COM)) ||                               \
