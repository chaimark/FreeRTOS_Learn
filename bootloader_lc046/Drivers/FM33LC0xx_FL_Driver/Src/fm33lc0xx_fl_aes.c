...
#define IS_FL_AES_KEYLENGTH(__VALUE__)                                                                                 \
    (((__VALUE__) == FL_AES_KEY_LENGTH_128B) || ((__VALUE__) == FL_AES_KEY_LENGTH_192B) ||                             \
     ((__VALUE__) == FL_AES_KEY_LENGTH_256B))

#define IS_FL_AES_CIPHERMODE(__VALUE__)                                                                                \
    (((__VALUE__) == FL_AES_CIPHER_ECB) || ((__VALUE__) == FL_AES_CIPHER_CBC) || ((__VALUE__) == FL_AES_CIPHER_CTR) || \
     ((__VALUE__) == FL_AES_CIPHER_MULTH))

#define IS_FL_AES_OPERATIONMODE(__VALUE__)                                                                             \
    (((__VALUE__) == FL_AES_OPERATION_MODE_ENCRYPTION) || ((__VALUE__) == FL_AES_OPERATION_MODE_KEYDERIVATION) ||      \
     ((__VALUE__) == FL_AES_OPERATION_MODE_DECRYPTION) ||                                                              \
     ((__VALUE__) == FL_AES_OPERATION_MODE_KEYDERIVATION_DECRYPTION))

#define IS_FL_AES_DATATYPE(__VALUE__)                                                                                  \
    (((__VALUE__) == FL_AES_DATA_TYPE_32B) || ((__VALUE__) == FL_AES_DATA_TYPE_16B) ||                                 \
     ((__VALUE__) == FL_AES_DATA_TYPE_8B) || ((__VALUE__) == FL_AES_DATA_TYPE_1B))
/**
 * @}
 */
