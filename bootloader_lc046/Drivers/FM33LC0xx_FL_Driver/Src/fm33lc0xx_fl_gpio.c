...
#define IS_FL_GPIO_MODE(__VALUE__)                                                                                     \
    (((__VALUE__) == FL_GPIO_MODE_ANALOG) || ((__VALUE__) == FL_GPIO_MODE_INPUT) ||                                    \
     ((__VALUE__) == FL_GPIO_MODE_OUTPUT) || ((__VALUE__) == FL_GPIO_MODE_DIGITAL))

#define IS_FL_GPIO_OPENDRAIN(__VALUE__)                                                                                \
    (((__VALUE__) == FL_GPIO_OUTPUT_OPENDRAIN) || ((__VALUE__) == FL_GPIO_OUTPUT_PUSHPULL))

#define IS_FL_GPIO_PULL_UP(__VALUE__) (((__VALUE__) == FL_DISABLE) || ((__VALUE__) == FL_ENABLE))


#define IS_FL_GPIO_WKUP_ENTRY(__VALUE__)                                                                               \
    (((__VALUE__) == FL_GPIO_WAKEUP_INT_ENTRY_NMI) || ((__VALUE__) == FL_GPIO_WAKEUP_INT_ENTRY_38))

#define IS_FL_GPIO_WKUP_EDGE(__VALUE__)                                                                                \
    (((__VALUE__) == FL_GPIO_WAKEUP_TRIGGER_RISING) || ((__VALUE__) == FL_GPIO_WAKEUP_TRIGGER_FALLING))


#define IS_FL_GPIO_WKUP_NUM(__VALUE__)                                                                                 \
    (((__VALUE__) == FL_GPIO_WAKEUP_0) || ((__VALUE__) == FL_GPIO_WAKEUP_1) || ((__VALUE__) == FL_GPIO_WAKEUP_2) ||    \
     ((__VALUE__) == FL_GPIO_WAKEUP_3) || ((__VALUE__) == FL_GPIO_WAKEUP_4) || ((__VALUE__) == FL_GPIO_WAKEUP_5) ||    \
     ((__VALUE__) == FL_GPIO_WAKEUP_6) || ((__VALUE__) == FL_GPIO_WAKEUP_7))
/**
 * @}
 */
