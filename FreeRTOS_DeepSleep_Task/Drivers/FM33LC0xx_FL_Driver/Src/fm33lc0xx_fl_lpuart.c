 ...
 * @{
 */
#define IS_LPUART_INSTANCE(INSTANCE) (((INSTANCE) == LPUART0) || ((INSTANCE) == LPUART1))

#define IS_FL_LPUART_CLKSRC(__VALUE__)                                                                                 \
    (((__VALUE__) == FL_RCC_LPUART_CLK_SOURCE_LSCLK) || ((__VALUE__) == FL_RCC_LPUART_CLK_SOURCE_RCHF) ||              \
     ((__VALUE__) == FL_RCC_LPUART_CLK_SOURCE_RCMF))

#define IS_FL_LPUART_BAUDRATE(__VALUE__)                                                                               \
    (((__VALUE__) == FL_LPUART_BAUDRATE_300) || ((__VALUE__) == FL_LPUART_BAUDRATE_600) ||                             \
     ((__VALUE__) == FL_LPUART_BAUDRATE_1200) || ((__VALUE__) == FL_LPUART_BAUDRATE_2400) ||                           \
     ((__VALUE__) == FL_LPUART_BAUDRATE_4800) || ((__VALUE__) == FL_LPUART_BAUDRATE_9600))

#define IS_FL_LPUART_DATAWIDTH(__VALUE__)                                                                              \
    (((__VALUE__) == FL_LPUART_DATA_WIDTH_6B) || ((__VALUE__) == FL_LPUART_DATA_WIDTH_7B) ||                           \
     ((__VALUE__) == FL_LPUART_DATA_WIDTH_8B) || ((__VALUE__) == FL_LPUART_DATA_WIDTH_9B))

#define IS_FL_LPUART_STOPBITS(__VALUE__)                                                                               \
    (((__VALUE__) == FL_LPUART_STOP_BIT_WIDTH_1B) || ((__VALUE__) == FL_LPUART_STOP_BIT_WIDTH_2B))

#define IS_FL_LPUART_PARITY(__VALUE__)                                                                                 \
    (((__VALUE__) == FL_LPUART_PARITY_NONE) || ((__VALUE__) == FL_LPUART_PARITY_EVEN) ||                               \
     ((__VALUE__) == FL_LPUART_PARITY_ODD))

#define IS_FL_LPUART_DIRECTION(__VALUE__)                                                                              \
    (((__VALUE__) == FL_LPUART_DIRECTION_NONE) || ((__VALUE__) == FL_LPUART_DIRECTION_RX) ||                           \
     ((__VALUE__) == FL_LPUART_DIRECTION_TX) || ((__VALUE__) == FL_LPUART_DIRECTION_TX_RX))
