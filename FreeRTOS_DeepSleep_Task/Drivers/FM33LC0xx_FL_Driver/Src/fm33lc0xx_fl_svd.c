...
#define IS_FL_SVD_WARNING_THRESHOLD_LEVEL(__VALUE__)                                                                   \
    (((__VALUE__) == FL_SVD_WARNING_THRESHOLD_GROUP0) || ((__VALUE__) == FL_SVD_WARNING_THRESHOLD_GROUP1) ||           \
     ((__VALUE__) == FL_SVD_WARNING_THRESHOLD_GROUP2) || ((__VALUE__) == FL_SVD_WARNING_THRESHOLD_GROUP3) ||           \
     ((__VALUE__) == FL_SVD_WARNING_THRESHOLD_GROUP4) || ((__VALUE__) == FL_SVD_WARNING_THRESHOLD_GROUP5) ||           \
     ((__VALUE__) == FL_SVD_WARNING_THRESHOLD_GROUP6) || ((__VALUE__) == FL_SVD_WARNING_THRESHOLD_GROUP7) ||           \
     ((__VALUE__) == FL_SVD_WARNING_THRESHOLD_GROUP8) || ((__VALUE__) == FL_SVD_WARNING_THRESHOLD_GROUP9) ||           \
     ((__VALUE__) == FL_SVD_WARNING_THRESHOLD_GROUP10) || ((__VALUE__) == FL_SVD_WARNING_THRESHOLD_GROUP11) ||         \
     ((__VALUE__) == FL_SVD_WARNING_THRESHOLD_GROUP12) || ((__VALUE__) == FL_SVD_WARNING_THRESHOLD_GROUP13) ||         \
     ((__VALUE__) == FL_SVD_WARNING_THRESHOLD_GROUP14) || ((__VALUE__) == FL_SVD_WARNING_THRESHOLD_GROUP15))

#define IS_FL_SVD_SVSCONFIG(__VALUE__) (((__VALUE__) == FL_DISABLE) || ((__VALUE__) == FL_ENABLE))

#define IS_FL_SVD_REFERENCE_VOLTAGE(__VALUE__)                                                                         \
    (((__VALUE__) == FL_SVD_REFERENCE_1P2V) || ((__VALUE__) == FL_SVD_REFERENCE_1P1V) ||                               \
     ((__VALUE__) == FL_SVD_REFERENCE_1P0V))

#define IS_FL_SVD_DIGITAL_FILTER(__VALUE__) (((__VALUE__) == FL_DISABLE) || ((__VALUE__) == FL_ENABLE))
/**
 *@}
 */
