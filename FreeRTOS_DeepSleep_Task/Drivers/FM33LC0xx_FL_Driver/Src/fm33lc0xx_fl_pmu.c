...
#define IS_FL_PMU_MODE(__VALUE__)                                                                                      \
    (((__VALUE__) == FL_PMU_POWER_MODE_ACTIVE_OR_LPACTIVE) || ((__VALUE__) == FL_PMU_POWER_MODE_LPRUN_ONLY) ||         \
     ((__VALUE__) == FL_PMU_POWER_MODE_SLEEP_OR_DEEPSLEEP))

#define IS_FL_PMU_COREVOLTAGESCALING(__VALUE__) (((__VALUE__) == FL_DISABLE) || ((__VALUE__) == FL_ENABLE))

#define IS_FL_PMU_DEEPSLEEP(__VALUE__)                                                                                 \
    (((__VALUE__) == FL_PMU_SLEEP_MODE_DEEP) || ((__VALUE__) == FL_PMU_SLEEP_MODE_NORMAL))

#define IS_FL_PMU_WAKEUPFREQUENCY(__VALUE__)                                                                           \
    (((__VALUE__) == FL_PMU_RCHF_WAKEUP_FREQ_8MHZ) || ((__VALUE__) == FL_PMU_RCHF_WAKEUP_FREQ_16MHZ) ||                \
     ((__VALUE__) == FL_PMU_RCHF_WAKEUP_FREQ_24MHZ))

#define IS_FL_PMU_LDOLOWMODE(__VALUE__)                                                                                \
    (((__VALUE__) == FL_PMU_LDO_LPM_DISABLE) || ((__VALUE__) == FL_PMU_LDO_LPM_ENABLE))

#define IS_FL_PMU_WAKEUPDELAY(__VALUE__)                                                                               \
    (((__VALUE__) == FL_PMU_WAKEUP_DELAY_0US) || ((__VALUE__) == FL_PMU_WAKEUP_DELAY_2US) ||                           \
     ((__VALUE__) == FL_PMU_WAKEUP_DELAY_4US) || ((__VALUE__) == FL_PMU_WAKEUP_DELAY_8US))
