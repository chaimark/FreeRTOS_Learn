...
#define IS_EXTI_ALL_INSTANCE(INSTANCE)                                                                                 \
    (((INSTANCE) == FL_GPIO_EXTI_LINE_0) || ((INSTANCE) == FL_GPIO_EXTI_LINE_1) ||                                     \
     ((INSTANCE) == FL_GPIO_EXTI_LINE_2) || ((INSTANCE) == FL_GPIO_EXTI_LINE_3) ||                                     \
     ((INSTANCE) == FL_GPIO_EXTI_LINE_4) || ((INSTANCE) == FL_GPIO_EXTI_LINE_5) ||                                     \
     ((INSTANCE) == FL_GPIO_EXTI_LINE_6) || ((INSTANCE) == FL_GPIO_EXTI_LINE_7) ||                                     \
     ((INSTANCE) == FL_GPIO_EXTI_LINE_8) || ((INSTANCE) == FL_GPIO_EXTI_LINE_9) ||                                     \
     ((INSTANCE) == FL_GPIO_EXTI_LINE_10) || ((INSTANCE) == FL_GPIO_EXTI_LINE_11) ||                                   \
     ((INSTANCE) == FL_GPIO_EXTI_LINE_12) || ((INSTANCE) == FL_GPIO_EXTI_LINE_13) ||                                   \
     ((INSTANCE) == FL_GPIO_EXTI_LINE_14))

#define IS_EXTI_CLK_SOURCE(__VALUE__)                                                                                  \
    (((__VALUE__) == FL_RCC_EXTI_CLK_SOURCE_HCLK) || ((__VALUE__) == FL_RCC_EXTI_CLK_SOURCE_LSCLK))

#define IS_EXTI_INPUT_GROUP(__VALUE__)                                                                                 \
    (((__VALUE__) == FL_GPIO_EXTI_INPUT_GROUP0) || ((__VALUE__) == FL_GPIO_EXTI_INPUT_GROUP1) ||                       \
     ((__VALUE__) == FL_GPIO_EXTI_INPUT_GROUP2) || ((__VALUE__) == FL_GPIO_EXTI_INPUT_GROUP3))

#define IS_EXTI_TRIG_EDGE(__VALUE__)                                                                                   \
    (((__VALUE__) == FL_GPIO_EXTI_TRIGGER_EDGE_RISING) || ((__VALUE__) == FL_GPIO_EXTI_TRIGGER_EDGE_FALLING) ||        \
     ((__VALUE__) == FL_GPIO_EXTI_TRIGGER_EDGE_BOTH) || ((__VALUE__) == FL_GPIO_EXTI_TRIGGER_EDGE_DISABLE))

#define IS_EXTI_FILTER(__VALUE__) (((__VALUE__) == FL_ENABLE) || ((__VALUE__) == FL_DISABLE))
...
static const pSetExtiLineFunc setExtiLineFuncs[] = {
    FL_GPIO_SetExtiLine0,  FL_GPIO_SetExtiLine1,  FL_GPIO_SetExtiLine2,  FL_GPIO_SetExtiLine3,  FL_GPIO_SetExtiLine4,
    FL_GPIO_SetExtiLine5,  FL_GPIO_SetExtiLine6,  FL_GPIO_SetExtiLine7,  FL_GPIO_SetExtiLine8,  FL_GPIO_SetExtiLine9,
    FL_GPIO_SetExtiLine10, FL_GPIO_SetExtiLine11, FL_GPIO_SetExtiLine12, FL_GPIO_SetExtiLine13, FL_GPIO_SetExtiLine14,
};
...
FL_ErrorStatus FL_EXTI_Init(uint32_t extiLineX, FL_EXTI_InitTypeDef* EXTI_InitStruct) {
    ...
    /* 设置数字滤波 */
    EXTI_InitStruct->filter == FL_ENABLE ? FL_GPIO_EnableDigitalFilter(GPIO, extiLineX)
