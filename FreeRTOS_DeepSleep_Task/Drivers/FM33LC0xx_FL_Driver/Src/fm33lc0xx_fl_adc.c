...
#define IS_FL_ADC_ADCCLK_SOURCE(__VALUE__)                                                                             \
    (((__VALUE__) == FL_RCC_ADC_CLK_SOURCE_RCMF_PSC) || ((__VALUE__) == FL_RCC_ADC_CLK_SOURCE_RCHF) ||                 \
     ((__VALUE__) == FL_RCC_ADC_CLK_SOURCE_XTHF) || ((__VALUE__) == FL_RCC_ADC_CLK_SOURCE_PLL))


#define IS_FL_ADC_ADCCLK_PRESCALER(__VALUE__)                                                                          \
    (((__VALUE__) == FL_RCC_ADC_PSC_DIV1) || ((__VALUE__) == FL_RCC_ADC_PSC_DIV2) ||                                   \
     ((__VALUE__) == FL_RCC_ADC_PSC_DIV4) || ((__VALUE__) == FL_RCC_ADC_PSC_DIV8) ||                                   \
     ((__VALUE__) == FL_RCC_ADC_PSC_DIV16) || ((__VALUE__) == FL_RCC_ADC_PSC_DIV32))


#define IS_FL_ADC_CONTINUOUSCONVMODE(__VALUE__)                                                                        \
    (((__VALUE__) == FL_ADC_CONV_MODE_SINGLE) || ((__VALUE__) == FL_ADC_CONV_MODE_CONTINUOUS))

#define IS_FL_ADC_AUTO_MODE(__VALUE__)                                                                                 \
    (((__VALUE__) == FL_ADC_SINGLE_CONV_MODE_AUTO) || ((__VALUE__) == FL_ADC_SINGLE_CONV_MODE_SEMIAUTO))


#define IS_FL_ADC_SCANDIRECTION(__VALUE__)                                                                             \
    (((__VALUE__) == FL_ADC_SEQ_SCAN_DIR_FORWARD) || ((__VALUE__) == FL_ADC_SEQ_SCAN_DIR_BACKWARD))


#define IS_FL_ADC_EXTERNALTRIGCONV(__VALUE__)                                                                          \
    (((__VALUE__) == FL_ADC_TRIGGER_EDGE_NONE) || ((__VALUE__) == FL_ADC_TRIGGER_EDGE_RISING) ||                       \
     ((__VALUE__) == FL_ADC_TRIGGER_EDGE_FALLING) || ((__VALUE__) == FL_ADC_TRIGGER_EDGE_BOTH))

#define IS_FL_ADC_EXTERNALTRIGSOURCE(__VALUE__)                                                                        \
    (((__VALUE__) == FL_ADC_TRGI_PA8) || ((__VALUE__) == FL_ADC_TRGI_PB9) || ((__VALUE__) == FL_ADC_TRGI_ATIM) ||      \
     ((__VALUE__) == FL_ADC_TRGI_GPTIM0) || ((__VALUE__) == FL_ADC_TRGI_GPTIM1) || ((__VALUE__) == FL_ADC_TRGI_RTC) || \
     ((__VALUE__) == FL_ADC_TRGI_BSTIM1) || ((__VALUE__) == FL_ADC_TRGI_COMP1) || ((__VALUE__) == FL_ADC_TRGI_COMP2))

#define IS_FL_ADC_CHANNEL_FAST_TIME(__VALUE__)                                                                         \
...
#define IS_FL_ADC_CHANNEL_SLOW_TIME(__VALUE__)                                                                         \
...
#define IS_FL_ADC_OVERSAMPCOFIG(__VALUE__) (((__VALUE__) == FL_DISABLE) || ((__VALUE__) == FL_ENABLE))

#define IS_FL_ADC_OVERSAMPINGRATIO(__VALUE__)                                                                          \
    (((__VALUE__) == FL_ADC_OVERSAMPLING_MUL_2X) || ((__VALUE__) == FL_ADC_OVERSAMPLING_MUL_4X) ||                     \
     ((__VALUE__) == FL_ADC_OVERSAMPLING_MUL_8X) || ((__VALUE__) == FL_ADC_OVERSAMPLING_MUL_16X) ||                    \
     ((__VALUE__) == FL_ADC_OVERSAMPLING_MUL_32X) || ((__VALUE__) == FL_ADC_OVERSAMPLING_MUL_64X) ||                   \
     ((__VALUE__) == FL_ADC_OVERSAMPLING_MUL_128X) || ((__VALUE__) == FL_ADC_OVERSAMPLING_MUL_256X))

#define IS_FL_ADC_OVERSAMPINGSHIFT(__VALUE__)                                                                          \
    (((__VALUE__) == FL_ADC_OVERSAMPLING_SHIFT_0B) || ((__VALUE__) == FL_ADC_OVERSAMPLING_SHIFT_1B) ||                 \
     ((__VALUE__) == FL_ADC_OVERSAMPLING_SHIFT_2B) || ((__VALUE__) == FL_ADC_OVERSAMPLING_SHIFT_3B) ||                 \
     ((__VALUE__) == FL_ADC_OVERSAMPLING_SHIFT_4B) || ((__VALUE__) == FL_ADC_OVERSAMPLING_SHIFT_5B) ||                 \
     ((__VALUE__) == FL_ADC_OVERSAMPLING_SHIFT_6B) || ((__VALUE__) == FL_ADC_OVERSAMPLING_SHIFT_7B) ||                 \
