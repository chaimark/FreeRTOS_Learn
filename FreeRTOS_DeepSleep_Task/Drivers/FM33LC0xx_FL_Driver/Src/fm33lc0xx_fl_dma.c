...
#define IS_FL_DMA_PRIORITY(__VALUE__)                                                                                  \
    (((__VALUE__) == FL_DMA_PRIORITY_LOW) || ((__VALUE__) == FL_DMA_PRIORITY_MEDIUM) ||                                \
     ((__VALUE__) == FL_DMA_PRIORITY_HIGH) || ((__VALUE__) == FL_DMA_PRIORITY_VERYHIGH))

#define IS_FL_DMA_CIRC_MODE(__VALUE__) (((__VALUE__) == FL_DISABLE) || ((__VALUE__) == FL_ENABLE))


#define IS_FL_DMA_DIRECTION(__VALUE__)                                                                                 \
    (((__VALUE__) == FL_DMA_DIR_PERIPHERAL_TO_RAM) || ((__VALUE__) == FL_DMA_DIR_RAM_TO_PERIPHERAL) ||                 \
     ((__VALUE__) == FL_DMA_DIR_FLASH_TO_RAM) || ((__VALUE__) == FL_DMA_DIR_RAM_TO_FLASH))


#define IS_FL_DMA_DATA_SIZE(__VALUE__)                                                                                 \
    (((__VALUE__) == FL_DMA_BANDWIDTH_8B) || ((__VALUE__) == FL_DMA_BANDWIDTH_32B) ||                                  \
     ((__VALUE__) == FL_DMA_BANDWIDTH_16B))

#define IS_FL_DMA_INCMODE(__VALUE__)                                                                                   \
    (((__VALUE__) == FL_DMA_MEMORY_INC_MODE_INCREASE) || ((__VALUE__) == FL_DMA_MEMORY_INC_MODE_DECREASE) ||           \
     ((__VALUE__) == FL_DMA_CH7_MEMORY_INC_MODE_INCREASE) || ((__VALUE__) == FL_DMA_CH7_MEMORY_INC_MODE_DECREASE) ||   \
     ((__VALUE__) == FL_DMA_CH7_FLASH_INC_MODE_INCREASE) || ((__VALUE__) == FL_DMA_CH7_FLASH_INC_MODE_DECREASE))

#define IS_FL_DMA_PERIPH(__VALUE__)                                                                                    \
    (((__VALUE__) == FL_DMA_PERIPHERAL_FUNCTION1) || ((__VALUE__) == FL_DMA_PERIPHERAL_FUNCTION2) ||                   \
     ((__VALUE__) == FL_DMA_PERIPHERAL_FUNCTION3) || ((__VALUE__) == FL_DMA_PERIPHERAL_FUNCTION4) ||                   \
     ((__VALUE__) == FL_DMA_PERIPHERAL_FUNCTION5) || ((__VALUE__) == FL_DMA_PERIPHERAL_FUNCTION6) ||                   \
     ((__VALUE__) == FL_DMA_PERIPHERAL_FUNCTION7) || ((__VALUE__) == FL_DMA_PERIPHERAL_FUNCTION8))
/**
 * @}
 */
