...
#define IS_FL_WWDT_OVERFLOWPERIOD(__VALUE__)                                                                           \
    (((__VALUE__) == FL_WWDT_PERIOD_1CNT) || ((__VALUE__) == FL_WWDT_PERIOD_4CNT) ||                                   \
     ((__VALUE__) == FL_WWDT_PERIOD_16CNT) || ((__VALUE__) == FL_WWDT_PERIOD_64CNT) ||                                 \
     ((__VALUE__) == FL_WWDT_PERIOD_128CNT) || ((__VALUE__) == FL_WWDT_PERIOD_256CNT) ||                               \
     ((__VALUE__) == FL_WWDT_PERIOD_512CNT) || ((__VALUE__) == FL_WWDT_PERIOD_1024CNT))
/**
 * @}
 */
