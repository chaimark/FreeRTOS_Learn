...
#define IS_FL_LPTIM32_OPCLK_SOURCE(__VALUE__)                                                                          \
    (((__VALUE__) == FL_RCC_LPTIM32_CLK_SOURCE_APB1CLK) || ((__VALUE__) == FL_RCC_LPTIM32_CLK_SOURCE_LSCLK) ||         \
     ((__VALUE__) == FL_RCC_LPTIM32_CLK_SOURCE_LPOSC) || ((__VALUE__) == FL_RCC_LPTIM32_CLK_SOURCE_RCMF_PSC))

#define IS_FL_LPTIM32_CLK_SOURCE(__VALUE__)                                                                            \
    (((__VALUE__) == FL_LPTIM32_CLK_SOURCE_INTERNAL) || ((__VALUE__) == FL_LPTIM32_CLK_SOURCE_EXTERNAL))

#define IS_FL_LPTIM32_PRESCALER(__VALUE__)                                                                             \
    (((__VALUE__) == FL_LPTIM32_PSC_DIV1) || ((__VALUE__) == FL_LPTIM32_PSC_DIV2) ||                                   \
     ((__VALUE__) == FL_LPTIM32_PSC_DIV4) || ((__VALUE__) == FL_LPTIM32_PSC_DIV8) ||                                   \
     ((__VALUE__) == FL_LPTIM32_PSC_DIV16) || ((__VALUE__) == FL_LPTIM32_PSC_DIV32) ||                                 \
     ((__VALUE__) == FL_LPTIM32_PSC_DIV64) || ((__VALUE__) == FL_LPTIM32_PSC_DIV128))

#define IS_FL_LPTIM32_MODE(__VALUE__)                                                                                  \
    (((__VALUE__) == FL_LPTIM32_OPERATION_MODE_NORMAL) ||                                                              \
...
#define IS_FL_LPTIM32_ETR_TRIGEER_EDGE(__VALUE__)                                                                      \
    (((__VALUE__) == FL_LPTIM32_ETR_TRIGGER_EDGE_RISING) || ((__VALUE__) == FL_LPTIM32_ETR_TRIGGER_EDGE_FALLING) ||    \
     ((__VALUE__) == FL_LPTIM32_ETR_TRIGGER_EDGE_BOTH))

#define IS_FL_LPTIM32_ONE_PULSE_MODE(__VALUE__)                                                                        \
    (((__VALUE__) == FL_LPTIM32_ONE_PULSE_MODE_CONTINUOUS) || ((__VALUE__) == FL_LPTIM32_ONE_PULSE_MODE_SINGLE))

#define IS_FL_LPTIM32_ETR_COUNT_EDGE(__VALUE__)                                                                        \
    (((__VALUE__) == FL_LPTIM32_ETR_COUNT_EDGE_RISING) || ((__VALUE__) == FL_LPTIM32_ETR_COUNT_EDGE_FALLING))

#define IS_FL_LPTIM32_IC_EDGE(__VALUE__)                                                                               \
    (((__VALUE__) == FL_LPTIM32_IC_EDGE_RISING) || ((__VALUE__) == FL_LPTIM32_IC_EDGE_FALLING) ||                      \
     ((__VALUE__) == FL_LPTIM32_IC_EDGE_BOTH))

#define IS_FL_LPTIM32_OC_POLARITY(__VALUE__)                                                                           \
    (((__VALUE__) == FL_LPTIM32_OC_POLARITY_NORMAL) || ((__VALUE__) == FL_LPTIM32_OC_POLARITY_INVERT))

#define IS_FL_LPTIM32_CHANNEL(__VALUE__)                                                                               \
    (((__VALUE__) == FL_LPTIM32_CHANNEL_1) || ((__VALUE__) == FL_LPTIM32_CHANNEL_2))

#define IS_FL_LPTIM32_CAPTURE_SOURCE(__VALUE__)                                                                        \
    (((__VALUE__) == FL_LPTIM32_IC_CAPTURE_SOURCE_GROUP0) || ((__VALUE__) == FL_LPTIM32_IC_CAPTURE_SOURCE_GROUP1) ||   \
     ((__VALUE__) == FL_LPTIM32_IC_CAPTURE_SOURCE_GROUP2) || ((__VALUE__) == FL_LPTIM32_IC_CAPTURE_SOURCE_GROUP3))
 ...
 *
 * @note   其中 @ref FL_LPTIM32_OPERATION_MODE_EXTERNAL_ASYNC_PULSE_CNT
 * 模式需要外部脉冲提供给LPTIM32模块作为工作时钟，此时 LPTIM32完全工作在异步模式下。
 * @param  LPTIM32x  外设入口地址
...
FL_ErrorStatus FL_LPTIM32_Init(LPTIM32_Type* LPTIM32x, FL_LPTIM32_InitTypeDef* initStruct) {
    ...
    case FL_LPTIM32_OPERATION_MODE_NORMAL: {
        if (initStruct->prescalerClockSource == FL_LPTIM32_CLK_SOURCE_EXTERNAL) {
            /* 配置外部计数边沿 */
