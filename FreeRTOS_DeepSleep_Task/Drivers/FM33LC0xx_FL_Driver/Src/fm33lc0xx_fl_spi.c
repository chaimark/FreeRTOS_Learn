 ...
 * @{
 */
#define IS_FL_SPI_INSTANCE(INTANCE) (((INTANCE) == SPI1) || ((INTANCE) == SPI2))

#define IS_FL_SPI_MODE(__VALUE__) (((__VALUE__) == FL_SPI_WORK_MODE_SLAVE) || ((__VALUE__) == FL_SPI_WORK_MODE_MASTER))

#define IS_FL_SPI_BITORDER(__VALUE__)                                                                                  \
    (((__VALUE__) == FL_SPI_BIT_ORDER_MSB_FIRST) || ((__VALUE__) == FL_SPI_BIT_ORDER_LSB_FIRST))

#define IS_FL_SPI_DATAWIDT(__VALUE__)                                                                                  \
    (((__VALUE__) == FL_SPI_DATA_WIDTH_8B) || ((__VALUE__) == FL_SPI_DATA_WIDTH_16B) ||                                \
     ((__VALUE__) == FL_SPI_DATA_WIDTH_24B) || ((__VALUE__) == FL_SPI_DATA_WIDTH_32B))

#define IS_FL_SPI_CLOCK_PHASE(__VALUE__) (((__VALUE__) == FL_SPI_PHASE_EDGE1) || ((__VALUE__) == FL_SPI_PHASE_EDGE2))

#define IS_FL_SPI_CLOCK_POLARITY(__VALUE__)                                                                            \
    (((__VALUE__) == FL_SPI_POLARITY_NORMAL) || ((__VALUE__) == FL_SPI_POLARITY_INVERT))

#define IS_FL_SPI_BAUDRATE(__VALUE__)                                                                                  \
    (((__VALUE__) == FL_SPI_BAUDRATE_DIV2) || ((__VALUE__) == FL_SPI_BAUDRATE_DIV4) ||                                 \
     ((__VALUE__) == FL_SPI_BAUDRATE_DIV8) || ((__VALUE__) == FL_SPI_BAUDRATE_DIV16) ||                                \
     ((__VALUE__) == FL_SPI_BAUDRATE_DIV32) || ((__VALUE__) == FL_SPI_BAUDRATE_DIV64) ||                               \
     ((__VALUE__) == FL_SPI_BAUDRATE_DIV128) || ((__VALUE__) == FL_SPI_BAUDRATE_DIV256))


#define IS_FL_SPI_TANSFERMODE(__VALUE__)                                                                               \
    (((__VALUE__) == FL_SPI_TRANSFER_MODE_FULL_DUPLEX) || ((__VALUE__) == FL_SPI_TRANSFER_MODE_HALF_DUPLEX))
