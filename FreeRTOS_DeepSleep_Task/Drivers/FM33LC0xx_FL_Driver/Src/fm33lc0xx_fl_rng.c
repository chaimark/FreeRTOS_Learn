...
#define IS_FL_RNG_CLOCK_PRESCALER(__VALUE__)                                                                           \
    (((__VALUE__) == FL_RCC_RNG_PSC_DIV1) || ((__VALUE__) == FL_RCC_RNG_PSC_DIV2) ||                                   \
     ((__VALUE__) == FL_RCC_RNG_PSC_DIV4) || ((__VALUE__) == FL_RCC_RNG_PSC_DIV8) ||                                   \
     ((__VALUE__) == FL_RCC_RNG_PSC_DIV16) || ((__VALUE__) == FL_RCC_RNG_PSC_DIV32))
/**
 *@}
 */
