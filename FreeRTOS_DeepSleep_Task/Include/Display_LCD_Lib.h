...
const uint8_t FONT_CODE_TABLE[] = {
    ...
    0x5c, 0x50, 0x01, 0x40, 0x08, 0x41, 0x09, 0x48,
0x49,0x00,0x54,0x76,0x47,0x40,0x76,//xiao_o,xiao_r,LINE1,LINE2,LINE3,LINE12,LINE13,LINE23,LINE123,SPACE,xiao_n,da_h,fan_f,mid_line,xiao_h
};
*/
#define da_I 1
#define da_A 10
